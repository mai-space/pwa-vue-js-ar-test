...
export default {
  name: "ARScene",
  mounted() {
    ArToolkitContext.baseURL = '/pwa-vue-js-ar-test/';
    ...
    var arToolkitContext = new ArToolkitContext({
      debug: false,
      cameraParametersUrl: ArToolkitContext.baseURL + 'assets/marker/12345/pattern-12345.patt',
      detectionMode: 'mono',
      canvasWidth: 640,
      canvasHeight: 490,
    ...
    var markerControls = new ArMarkerControls(arToolkitContext, markerGroup, {
      type: 'pattern',
      patternUrl: ArToolkitContext.baseURL + 'assets/marker/12345/pattern-12345.patt',
      smooth: true,
      smoothCount: 5,
    ...
    loader.load(ArToolkitContext.baseURL + 'assets/marker/12345/model.glb', (gltf) => {
